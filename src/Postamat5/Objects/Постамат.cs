...
namespace IIS.Postamat5
{
    ...
    public class Постамат : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Postamat5.Статусы fСтатус;
        
        private IIS.Postamat5.СлужбаДоставки fСлужбаДоставки;
        
        private IIS.Postamat5.DetailArrayOfЯчейка fЯчейка;
        ...
        public virtual IIS.Postamat5.Статусы Статус
        {
            get
            {
                ...
                IIS.Postamat5.Статусы result = this.fСтатус;
        ...
        [PropertyStorage(new string[] {
                "СлужбаДоставки"})]
        [NotNull()]
        public virtual IIS.Postamat5.СлужбаДоставки СлужбаДоставки
        {
            get
            {
                ...
                IIS.Postamat5.СлужбаДоставки result = this.fСлужбаДоставки;
        ...
        public virtual IIS.Postamat5.DetailArrayOfЯчейка Ячейка
        {
            get
            {
                ...
                {
                    this.fЯчейка = new IIS.Postamat5.DetailArrayOfЯчейка(this);
                }
                IIS.Postamat5.DetailArrayOfЯчейка result = this.fЯчейка;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПостаматE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПостаматE", typeof(IIS.Postamat5.Постамат));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПостаматL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПостаматL", typeof(IIS.Postamat5.Постамат));
                }
            }
        }
    }
