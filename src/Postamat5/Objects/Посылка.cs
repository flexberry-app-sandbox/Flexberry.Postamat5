...
namespace IIS.Postamat5
{
    ...
    [View("ПосылкаE", new string[] {
            ...
            "Логистика.Состояние as \'Состояния посылки\'",
    ...
    public class Посылка : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Postamat5.Статус fСтатус;
        
        private IIS.Postamat5.Логистика fЛогистика;
        
        private IIS.Postamat5.Транзакция fТранзакция;
        
        private IIS.Postamat5.Хранение fХранение;
        ...
        public virtual IIS.Postamat5.Статус Статус
        {
            get
            {
                ...
                IIS.Postamat5.Статус result = this.fСтатус;
        ...
        [PropertyStorage(new string[] {
                "Логистика"})]
        [NotNull()]
        public virtual IIS.Postamat5.Логистика Логистика
        {
            get
            {
                ...
                IIS.Postamat5.Логистика result = this.fЛогистика;
        ...
        [PropertyStorage(new string[] {
                "Транзакция"})]
        [NotNull()]
        public virtual IIS.Postamat5.Транзакция Транзакция
        {
            get
            {
                ...
                IIS.Postamat5.Транзакция result = this.fТранзакция;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Postamat5.Хранение.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Хранение"})]
        public virtual IIS.Postamat5.Хранение Хранение
        {
            get
            {
                ...
                IIS.Postamat5.Хранение result = this.fХранение;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПосылкаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПосылкаE", typeof(IIS.Postamat5.Посылка));
                }
            }
        }
    }
    ...
    public class DetailArrayOfПосылка : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Postamat5.DetailArrayOfПосылка members)

        // *** End programmer edit section *** (IIS.Postamat5.DetailArrayOfПосылка members)
        ...
        /// </summary>
        public DetailArrayOfПосылка(IIS.Postamat5.Хранение fХранение) : 
                base(typeof(Посылка), ((ICSSoft.STORMNET.DataObject)(fХранение)))
        {
        }
        
        public IIS.Postamat5.Посылка this[int index]
        {
            get
            {
                return ((IIS.Postamat5.Посылка)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Postamat5.Посылка dataobject)
        {
