...
namespace IIS.Postamat5
{
    ...
    public class Транзакция : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Postamat5.Оплата fОплата;
        
        private double fСумма;
        
        private IIS.Postamat5.Пользователь fПользователь;
        ...
        public virtual IIS.Postamat5.Оплата Оплата
        {
            get
            {
                ...
                IIS.Postamat5.Оплата result = this.fОплата;
        ...
        [PropertyStorage(new string[] {
                "Пользователь"})]
        [NotNull()]
        public virtual IIS.Postamat5.Пользователь Пользователь
        {
            get
            {
                ...
                IIS.Postamat5.Пользователь result = this.fПользователь;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТранзакцияE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТранзакцияE", typeof(IIS.Postamat5.Транзакция));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ТранзакцияL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТранзакцияL", typeof(IIS.Postamat5.Транзакция));
                }
            }
        }
    }
