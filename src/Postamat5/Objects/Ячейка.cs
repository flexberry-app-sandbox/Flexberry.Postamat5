...
namespace IIS.Postamat5
{
    ...
    [View("ЯчейкаE", new string[] {
            ...
            "Хранение.Продление as \'Продлен на 3 дня\'"}, Hidden=new string[] {
            "Хранение.Номер",
            "Хранение.ДатаНачала",
    ...
    public class Ячейка : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Postamat5.Постамат fПостамат;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Postamat5.Постамат.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Постамат"})]
        public virtual IIS.Postamat5.Постамат Постамат
        {
            get
            {
                ...
                IIS.Postamat5.Постамат result = this.fПостамат;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЯчейкаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЯчейкаE", typeof(IIS.Postamat5.Ячейка));
                }
            }
        }
    }
    ...
    public class DetailArrayOfЯчейка : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Postamat5.DetailArrayOfЯчейка members)

        // *** End programmer edit section *** (IIS.Postamat5.DetailArrayOfЯчейка members)
        ...
        /// </summary>
        public DetailArrayOfЯчейка(IIS.Postamat5.Постамат fПостамат) : 
                base(typeof(Ячейка), ((ICSSoft.STORMNET.DataObject)(fПостамат)))
        {
        }
        
        public IIS.Postamat5.Ячейка this[int index]
        {
            get
            {
                return ((IIS.Postamat5.Ячейка)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Postamat5.Ячейка dataobject)
        {
